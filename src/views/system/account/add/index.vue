<template>
  <div class="page">
    ...
    <div class="table-main">
      ...
      <div class="btn-box">
        <el-button type="primary" size="small" :loading='btnLoading' @click="btnLoading = true;$throttle(saveUserDetail)">{{ $text.confirm }}</el-button>
        <el-button type="primary" size="small" @click="back" plain>{{ $text.cancel }}</el-button>
      </div>
    </div>
    <el-dialog

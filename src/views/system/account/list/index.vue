<template>
  <div class="page">
    <div class="toolbar-box account-toolbar-box">
      ...
      <el-button type="primary" @click="searchUserListByPage">{{ $text.search }}</el-button>
    </div>
    <div class="table-main">
      <div class="actionbar">
        <el-button type="primary" icon="el-icon-plus" @click="goAddAccount" v-if="permission.includes('ZBPCA01030101')">{{ $text.newAdd }}</el-button>
        <el-button type="primary" @click="enableUserFunc" v-if="permission.includes('ZBPCA01030102')">{{ $text.enable }}</el-button>
        <el-button type="primary" @click="disableUserFunc" v-if="permission.includes('ZBPCA01030103')">{{ $text.disable }}</el-button>
        <el-button type="primary" @click="edit" v-if="permission.includes('ZBPCA01030104')">修改</el-button>
      </div>
      <div class="table">
        <el-table
          :data="tableData"

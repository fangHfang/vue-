// src/views/system/account/role/index
import { pageSearchRole } from "@/api/system/account/role";
export default {
  "name": "AccountManageConfig",
  "components": {
  },
  "props": {
    "roles": {
  ...
  "methods": {
    ...
    listSearchRoleByPage() {
      ...
      const params = "page.pageNum=" + this.pagination.current + "&page.pageSize=" + this.pagination.size + "&name=" + this.toolBar.name + "&status=" + this.toolBar.class.value + "&appType=" + 0;

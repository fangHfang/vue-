    ...
    <div class="dialog-toolbar">
      <div class="toolbar-box dialog-set-list-toolbar">
        ...
        <div>
          ...
          <div class="content">
            <el-select clearable v-model="toolBar.class.storeLebelValue" placeholder="请选择门店性质">
              <el-option
        ...
        <div>
          ...
          <div class="content">
            <el-select clearable v-model="toolBar.class.value" placeholder="请选择门店标签">
              <el-option
        ...
        <div>
          <div class="label">经销商标签</div>
          <div class="content">
            <el-select clearable v-model="toolBar.class.distributorValue" placeholder="检索门店标签">
              <el-option
                  v-for="item in toolBar.class.distributorOptions"
                  :key="item.distributorValue"
                  :label="item.distributorLabel"
                  :value="item.distributorValue">
              </el-option>
            </el-select>
          </div>
        </div>

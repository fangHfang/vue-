    ...
    <div class="item-box" v-show="showWhiteListContent" >
      ...
      <div class="toolbar-box">
        <div>
          ...
          <div class="content">
<!--            <el-input v-model="toolBar.dealerCustomerNo" clearable placeholder="请输入经销商code"></el-input>-->
        ...
        <div>
          ...
          <div class="content">
<!--            <el-input v-model="toolBar.storeCustomerNo" clearable placeholder="请输入门店code"></el-input>-->

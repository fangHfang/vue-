export default {
  "name": "PackageProductActivityOrderManageDetail",
  "components": {
  },
  data() {
    return {
      ...
      "rowsMoreTableData": [
        {
          "one": "A活动优惠券 3871298379",
          "two": "10.00元"
        },
        {
          "one": "B活动优惠券 3871298379",
          "two": "10.00元"
        }
      ],
      "rowsMoreTableDataTwo": [
        {
          "one": "5000",
          "two": "30.00元",
          "three": "兑换点规则/兑换点分数;兑换点规则/兑换点分数;兑换点规则/兑换点分数"
        }
      ],
      "dialogVisible": false,
      "tableDetailShow": true,
      "tableDetailShowTwo": true
    };
  },
  "computed": {},
  mounted() {

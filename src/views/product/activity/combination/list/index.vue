  ...
  <div class="page">
    <div class="toolbar-box">
      <div>
        ...
        <div class="content">
          <el-input v-model="toolBar.name" placeholder="请输入活动名称" @keyup.native.enter="searchDataPage"></el-input>
        </div>
      </div>
      <div>
    ...
    <div class="table-main">
      <div class="actionbar" v-show="activeName !== 'third'">
        ...
        <el-button type="primary" class="reset" @click="modifySaleStatus(1)" v-if="permission.includes('ZBPCD01030604')">{{ $text.upShelf }}</el-button>
        <el-button type="primary" class="reset" @click="modifySaleStatus(0)" v-if="permission.includes('ZBPCD01030605')">{{ $text.downShelf }}</el-button>

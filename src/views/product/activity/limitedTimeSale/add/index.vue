    ...
    <el-form :model="form" :rules="rules" ref="formRef" label-width="90px">
      ...
      <div class="item-box">
        ...
        <div class="table-main">
          <div class="actionbar" v-if="identity!=='detail'">
            <el-button type="primary" @click="removeBatch">批量取消</el-button>
            <importExport
                :showImport="true"
            />
          </div>
      ...
      <div class="item-box">
        <div class="table-main gray-bg-box">
          <div class="gray-bg-box" v-if="identity!=='detail'">
            <el-form-item label="选择商品" style="margin:0" label-width="100px">
              <el-button @click="addProduct" type="primary">添加商品</el-button>
            </el-form-item>
          </div>
          <div class="table">
            <el-table
                :data="flashsaleCreateReqs"

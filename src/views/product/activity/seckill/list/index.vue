  ...
  <div class="page">
    ...
    <div class="table-main">
      <div class="actionbar" v-show="activeName !== 'third'">
        <el-button type="primary" @click="addOrEdit" v-if="permission.includes('ZBPCD01030401')"><i class="iconfont jia"></i> 新增</el-button>
        <el-button type="primary" class="reset" @click="modifySaleStatus(1)" v-if="permission.includes('ZBPCD01030404')">{{ $text.upShelf }}</el-button>
        <el-button type="primary" class="reset" @click="modifySaleStatus(0)" v-if="permission.includes('ZBPCD01030405')">{{ $text.downShelf }}</el-button>
        <el-button type="primary" class="reset" v-if="permission.includes('ZBPCD01030406')" @click="copyActivity">复制活动</el-button>
        <importExport
            :showExport="true"
            :exportUrl="exportUrl"
            :exportGetData="exportGetData"
            exportFileName="秒杀活动导出"
        />
      </div>
      <div class="table">
        <el-table
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
                size="small"
                v-if="permission.includes('ZBPCD01030402')"
              ...
              <el-button
                  v-if="scope.row.saleStatus === 0 && permission.includes('ZBPCD01030404')"
                  type="text"
                  size="small"
              ...
              <el-button
                  v-if="scope.row.saleStatus === 1 && permission.includes('ZBPCD01030405')"
                  type="text"
                  size="small"
              ...
              <el-button
                ...
                v-if="permission.includes('ZBPCD01030403')"

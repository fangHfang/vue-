<template>
  <div class="page">
    ...
    <div class="table-main">
      <div class="actionbar">
        <!-- 下架 -->
        <el-button type="primary" @click="batchDownShelf" v-if="permission.includes('ZBPCD01010607')">{{ $text.downShelf }}</el-button>
        <!-- 导出 -->
        <importExport
          :showExport="permission.includes('ZBPCD01010603')"
          :exportUrl="exportUrl"
          :exportGetData="exportGetData"
          exportFileName="非玛吉斯出售中商品导出"
      />
      </div>
      <div class="table">
        <el-table
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button
                type="text"
                size="small"
                 v-if="permission.includes('ZBPCD01010607')"

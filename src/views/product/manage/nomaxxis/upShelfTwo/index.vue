  ...
  <div class="page">
    <div class="page-content" style="padding-bottom: 0;">
      ...
      <div class="item-box">
        <h4 class="item-title">
          ...
          <div class="actionbar">
            <el-button v-show="showWhiteListContent" type="primary" :disabled="detail" @click="setVisibility">设置可见性</el-button>
          </div>
        </h4>
    ...
    <div class="table-main">
      <div class="btn-box" style="padding-bottom: 30px;">
        ...
        <el-button type="primary" :loading='btnLoading' @click="btnLoading = true;$throttle(applyUpShelf)" v-if="!detail">申请上架</el-button>

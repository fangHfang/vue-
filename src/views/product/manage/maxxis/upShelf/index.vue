  ...
  <div class="page">
    <div class="page-content" style="padding-bottom: 0;">
      ...
      <el-form :model="form" :rules="rules" ref="formRef" label-width="90px" label-position="left">
        <div class="item-box">
          <h4 class="item-title">
            返利规则设置
            <el-switch v-model="form.rebateRule.status" :disabled="detail" style="margin-left:10px;" />
        ...
        <div class="item-box">
          <h4 class="item-title">
            积分规则设置
            <el-switch v-model="form.integralRole.status" :disabled="detail" style="margin-left:10px;" />
            <span class="normal">（单选）</span>
          </h4>
          <div class="del-form">
    ...
    <div class="table-main">
      <div class="btn-box" style="padding-bottom: 30px;">
        <el-button type="primary" v-if="!detail" :loading='btnLoading' @click="applySaleStepOne">暂存</el-button>
        <el-button type="primary" :loading='btnLoading' @click="toPutOnTwo">下一步</el-button>

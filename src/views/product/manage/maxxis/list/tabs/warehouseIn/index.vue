  ...
  <div class="page">
    ...
    <div class="table-main">
      <div class="actionbar">
        <!-- 新建 -->
        <el-button
         v-if="permission.includes('ZBPCD01010501')"
          type="primary"
          icon="el-icon-plus"
          @click="toAddProduct"
        >
        ...
        <!-- 上架 -->
        <el-button type="primary" v-if="permission.includes('ZBPCD01010502')" @click="batchUpShelf">{{ $text.upShelf }}</el-button>
        <!-- 导入导出 -->
        <importExport
          :showImport="permission.includes('ZBPCD01010503')"
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button
                type="text"
                size="small"
                 v-if="permission.includes('ZBPCD01010502')"
              ...
              <el-button
                type="text"
                size="small"
                 v-if="permission.includes('ZBPCD01010504')"

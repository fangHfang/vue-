    ...
    <div class="table-main">
      <div class="actionbar">
        <el-button
          type="primary"
          @click="toAdd"
          v-if="permission.includes('ZBPCC01090101')"
          >
          新增资讯
        </el-button>
        <el-button type="primary" @click="toEdit" v-if="permission.includes('ZBPCC01090102')">{{ $text.edit }}</el-button>
        <el-button type="primary" @click="changeAllStatus(1)" v-if="permission.includes('ZBPCC01090104')">{{ $text.enable }}</el-button>
        <el-button type="primary" @click="changeAllStatus(0)" v-if="permission.includes('ZBPCC01090103')">{{ $text.stopUsing }}</el-button>
      </div>
      <div class="table">
        <el-table
          :data="tableData"
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button
                ...
                v-if="scope.row.status ==0 && permission.includes('ZBPCC01090104') "
              >
               ...
               <el-button
                ...
                size="small"
                @click.stop="changeStatus(scope.row,'status')"
                v-if="scope.row.status !=0 && permission.includes('ZBPCC01090103') "
              >
                {{ [$text.enable , $text.stopUsing ][scope.row.status] }}
              </el-button>
              <el-button

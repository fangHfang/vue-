  ...
  "methods": {
    ...
    getRemoteTableData() {
      const params = {
        ...
        "storeName": this.toolBar.storeName
      };
    ...
    toEdit() {
      ...
      this.$router.push({ "path": "/business/repository/info/edit/" + multipleSelection[0].articleNo });
    },
    /**
     * 批量改变状态值
     * @param status
     ...
     */
    toAdd() {
      this.$router.push({ "path": "/business/repository/info/add" });
    },
    /**
     * 跳转到资讯详情
     */
    toDetail(row) {
      this.$router.push({ "path": "/business/repository/info/detail/" + row.articleNo });
    },
    /**
     * 跳转到资讯详情
     */

<template>
  <div class="page-content">
    <h3 class="page-name">手动出库</h3>
    <el-form :model="form" ref="form" label-width="100px">
      <div class="del-form">
        <div class="item-box">
          <h4 class="item-title">出库产品</h4>
              ...
              >
                ...
                >
                  <template slot-scope="scope">
                    <el-input size="mini" v-model="currentTableData[scope.$index].count" type="input" @input="changeInput(currentTableData[scope.$index].count,scope.$index)" placeholder="请填写出库数量">
                    </el-input>
                  </template>
                </el-table-column>
                <el-table-column

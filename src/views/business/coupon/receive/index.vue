  ...
  <div class="page">
    <div class="toolbar-box">
      ...
      <div>
        ...
        <div class="content">
           <el-select clearable v-model="toolBar.isReceived.value" placeholder="请选择领取状态">
            <el-option
              v-for="item in toolBar.isReceived.options"
              :key="item.value"
              :label="item.label"
              :value="item.value">
            </el-option>
    ...
    <div class="table-main">
      <div class="actionbar">
        <importExport
            :showExport="permission.includes('ZBPCC01070201')"
        />
      </div>
      <div class="table">
        <el-table
        ...
        >
          ...
          >
            <template slot-scope="scope">
              <div>
                <i-status :type="['error', 'success'][scope.row.isReceived ? 1 : 0]" :message="['待领取', '已领取'][scope.row.isReceived ? 1 : 0]" />
              </div>
            </template>
          </el-table-column>
          <el-table-column

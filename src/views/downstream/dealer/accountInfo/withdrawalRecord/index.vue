    ...
    <div class="page-content" style="padding: 0;">
      ...
      <div class="toolbar-box down-store-info-list-toolbar">
        ...
        <div>
          ...
          <div class="content">
            <el-input clearable v-model="toolBar.billNo" placeholder="请输入对账单号/结算单号"></el-input>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="content">
            <el-select clearable v-model="currentStatus.value" :placeholder="$text.selectPlaceholder">
            <el-option
              v-for="item in currentStatus.options"
              :key="item.value"
              :label="item.label"
              :value="item.value">
            </el-option>

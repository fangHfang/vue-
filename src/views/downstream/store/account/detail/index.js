// src/views/downstream/store/account/detail/index
import { detailUserAccount } from "@/api/downstream/store/account";
export default {
  "name": "StoreAccountManageDetail",
  "components": {
  },
  data() {
    return {
      "toolBar": {
        ...
        "password": "********",
        "remarks": "还不错还不错还不错还不错还不错还不错还不错还不错",
        "status": "1",
